! function( $ ) {
	...
	Codevz_Plus.parallax = function() {
		...
		// On mousemove.
		body.find( '[class*="cz_mparallax_"]' ).codevz( 'mparallax', function( x ) {
		...
		// On scroll.
		var par = body.find( '[class*="cz_parallax_"]' ),
			all = par.length - 1;

		par.codevz( 'parallax', function( x, i ) {
